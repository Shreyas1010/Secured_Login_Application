...
import EmployeesReadOnly from "./EmployeesReadOnly";
...
export default function AdminPage() {
  ...
  useEffect(() => {
    ...
    // must be ADMIN to stay on this page
  ...
  return (
    <div style={{ textAlign: "center", marginTop: "30px" }}>
      ...
      <button onClick={handleLogout} style={{ padding: "8px 16px", marginBottom: 16 }}>
        Logout
      </button>

      {/* Employees read-only list (uses existing table) */}
      <EmployeesReadOnly />
    </div>
  );
}
